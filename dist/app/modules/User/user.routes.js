...
router.get("/users", (0, auth_1.default)(client_1.Role.admin, client_1.Role.admin), user_controller_1.userController.getAllUser);
...
router.patch("/:id/role", (0, auth_1.default)(client_1.Role.admin), 
